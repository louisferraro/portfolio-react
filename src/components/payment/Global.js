...
export default function Global() {
  ...
  <Row>
    ...
    <Nav >
    <Nav.Item>
      <Nav.Link href="/Cards"><h5>Cards</h5></Nav.Link>
    </Nav.Item>
    <Nav.Item>
      <Nav.Link eventKey=" SEPA iDEAL"><h5> SEPA Debit</h5></Nav.Link>
    </Nav.Item>
    <Nav.Item>
      <Nav.Link eventKey=" IDEAL"><h5>IDEAL </h5></Nav.Link>
    </Nav.Item>
    <Nav.Item>
    <Nav.Link eventKey="Alipay "><h5>Alipay</h5></Nav.Link>
  ...
  <Image fluid src="/static/payment/card.png " className="shadow-lg" />
